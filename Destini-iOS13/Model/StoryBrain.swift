...
struct StoryBrain {
    ...
    mutating func checkAnswer(userAnswer:String) {
        if userAnswer == storyData[storyNumber].choice1 {
            storyNumber = storyData[storyNumber].choice1Destination
        } else {
            storyNumber = storyData[storyNumber].choice2Destination
        }
    }
    
    func getStoryTitle() -> String {
        return storyData[storyNumber].title
    }
    
    func getButtonChoice1() -> String {
        return storyData[storyNumber].choice1
    }
    
    func getButtonChoice2() -> String {
